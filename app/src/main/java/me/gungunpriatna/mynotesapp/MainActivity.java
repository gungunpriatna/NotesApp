package me.gungunpriatna.mynotesapp;
...
import me.gungunpriatna.mynotesapp.adapter.NoteAdapter;
import me.gungunpriatna.mynotesapp.db.NoteHelper;
import me.gungunpriatna.mynotesapp.entity.Note;

import static me.gungunpriatna.mynotesapp.FormAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class LoadNoteAsync extends AsyncTask<Void, Void, ArrayList<Note>> {
        ...
        protected void onPostExecute(ArrayList<Note> notes) {
            ...
            if (list.size() == 0) {
                showSnackbarMessage("Tidak ada data saat init");
            }
        }
    }
